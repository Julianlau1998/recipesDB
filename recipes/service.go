...
func (s *Service) getRecipes(offset int64, randomisation int64, fulltext string) ([]models.Recipe, error) {
	recipes, err := s.recipeRepo.getRecipes(offset, randomisation, fulltext)
	if err != nil {
		return nil, err
	}
...
func (s *Service) getByCategory(category string, offset int64, randomisation int64, fulltext string) ([]models.Recipe, error) {
	recipes, err := s.recipeRepo.getByCategory(category, offset, randomisation, fulltext)
	if err != nil {
		return nil, err
	}
